...
EdgeHomeAI 系统集成了基于大语言模型（LLM）的 AI Agent 对话式任务编排功能，通过 OpenAI 的 GPT 模型实现自然语言理解和任务分解。该模块允许用户使用自然语言与系统交互，自动完成复杂的设备控制任务。
...
| `MODEL_NAME` | String | gpt-4o-mini | 使用的模型名称 |
...
#### 8.5.1 OpenAI Python SDK Installation
